...
$sql2 = "UPDATE `student` SET `FirstName`='$fname',`LastName`='$lname',`FatherName`='$fathername',`Email`='$email',`RollNo`='$rollno',`Mobile`='$mobile',`Address`='$address',`City`='$city',`State`='$state',`Country`='$country',`semester`='$sem' WHERE UID='$ids';";
